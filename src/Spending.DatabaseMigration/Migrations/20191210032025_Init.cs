...
namespace Spending.DatabaseMigration.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_Amount_TransactionTypeId_Date_Description_UserId",
                table: "Transaction",
                columns: new[] { "Amount", "TransactionTypeId", "Date", "Description", "UserId" },
                unique: true,
                filter: "[Date] IS NOT NULL AND [Description] IS NOT NULL");
